...
class PDF extends FPDF
{
    ...
    function TableHeader()
    {
        ...
        $this->Cell(40, 7, 'DNI', 1);
        $this->Cell(40, 7, 'Nombre', 1);
        $this->Cell(40, 7, 'Apellido', 1);
        $this->Cell(40, 7, 'Circuito', 1);
        $this->Cell(35, 7, 'Movilizadores', 1);
    ...
    function TableBody($data)
    {
        ...
        foreach ($data as $row) {
            $this->Cell(40, 6, $row['DNI'], 1);
            $this->Cell(40, 6, $row['Nombre'], 1);
            $this->Cell(40, 6, $row['Apellido'], 1);
            $this->Cell(40, 6, $row['Circuito'], 1);
            $this->Cell(35, 6, $row['CantidadMovilizadores'], 1);
        ...
        $this->Ln(5);
        $this->SetFont('Arial', 'B', 10);
        $this->Cell(195, 7, 'Total de Votantes', 1);
